;(function($, window, document,undefined) {
  var cjjTable = function(ele,opt){
        ...
        console.log(ele.selector+"-------"+ele.selector+2);
  }
  cjjTable.prototype = {
        start:function(){
            var _this = this;
            ...
            "<td>"+
            "<tr>";
            _this.$element.html("<table id='"+_this.$element.selector.substr(1)+"2' class='CJJ-Table'><thead>"+titlelistBox+"</thead><tbody>"+histroy_DDBox+"</tbody><tfoot>"+buttonTfoot+"</tfoot></table>");
